...
$users = Get-ADUser -SearchBase "OU=Tree,OU=Forest,OU=Earth,DC=Your,DC=Company,DC=com" -filter {userAccountControl -eq "512"} | Select-Object -Property userprincipalname
